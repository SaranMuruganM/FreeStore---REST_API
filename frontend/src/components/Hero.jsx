...
const Hero = () => {
  return (
    <div className="grid lg:grid-flow-col place-items-center gap-3  text-sm md:px-[15rem]">
      <div className="space-y-8 order-2 lg:order-1">
        ...
        <a target="_blank" className="flex items-center gap-4 p-3 border text-m bg-[#036D19] text-white rounded-md w-fit">
